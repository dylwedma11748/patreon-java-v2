...
public class User extends BaseResource {
	...
	/**
	 * Returns information about the user’s campaign if applicable.
	 * 
	...
	/**
	 * Returns the memberships to the campaigns that this user is a member of. This
	 * may return null if this User resource was pulled from a Member resource.
	 * 
