...
public class Goal extends BaseResource {
	...
	/**
	 * This enum represents the different fields or properties associated with the Goal resource.
	 */
	...
	public Goal(@JsonProperty("amount_cents") int amountCents,
			@JsonProperty("completed_percentage") int completedPercentage,
			@JsonProperty("created_at") String createdAt, @JsonProperty("description") String description,
			@JsonProperty("reached_at") String reachedAt, @JsonProperty("title") String title,
	...
	/**
     * Returns the completion percentage of this goal. Equal to (pledge_sum/goal amount) * 100, helpful when a creator.
     * 
     * @return the goal amount in cents
     */
	 ...
	 * 
	 * @return the date and time that the campaign reached the goal (UTC ISO format) or null
	 */
	...
	/**
	 * Returns the campaign trying to reach the goal (Currently a dead end)
	 * 
